class ImageProcessing{
	public:
		int getWallCurve(ImagePPM image);
		int* getCenterRow(ImagePPM image);
		int getExit(ImagePPM image);
		int hasWall(ImagePPM image);
		int hasObstacle(ImagePPM image);
	private:
 ...
 */
int ImageProcessing::hasWall(ImagePPM image){
 ...
 */
int ImageProcessing::hasObstacle(ImagePPM image){
	// bottom column
 ...
 */
int ImageProcessing::getWallCurve(ImagePPM image){
 ...
 */
int ImageProcessing::isRed(ImagePPM image, int row, int col){
	// check white by looking at the luminocity
